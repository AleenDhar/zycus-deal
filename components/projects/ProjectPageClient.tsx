...
export function ProjectPageClient({
    ...
    const handleSubmitNewChat = async (e: React.FormEvent) => {
        ...
        // The ChatInterface will handle sending the first message
        // We pass the initial message via a ref/state trick below
    };
        ...
        <div className="flex flex-col w-full max-w-screen-xl mx-auto px-4 py-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div className="lg:col-span-2">
                    {activeChatId ? (
                        /* Active Chat View — ChatInterface embedded inline */
